...
#line 1 "three_add_code.y" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "NUM", "'+'", "$accept", "P", "E", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 55 "three_add_code.y" /* yacc.c:1646  */
    {printf("%d\n",Index ); display_Quadruple();}
#line 1238 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 56 "three_add_code.y" /* yacc.c:1646  */
    {
	char str[5],str1[5]="t";
...
#line 1253 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 67 "three_add_code.y" /* yacc.c:1646  */
    {
	char str[5];
	sprintf(str,"%d",(yyvsp[0]));
	push(str);
}
...
#line 72 "three_add_code.y" /* yacc.c:1906  */
